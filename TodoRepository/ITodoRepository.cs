...
namespace TodoRepository
{
    public interface ITodoRepository
    {
        ...
        /// <param name=" userId ">
        ///     Id of the user that is trying to fetch the
        ///     data
        /// </param>
        ...
        /// <param name=" todoId "> Todo Id </param>
        /// <param name=" userId ">
        ///     Id of the user that is trying to remove the
        ///     data
        /// </param>
        ...
        /// <param name=" userId ">
        ///     Id of the user that is trying to update the
        ///     data
        /// </param>
        ...
        /// <param name=" todoId "> Todo Id </param>
        /// <param name=" userId ">
        ///     Id of the user that is trying to mark as
        ///     completed
        /// </param>
        /// <returns> True if success , false otherwise </returns>
